...
func (m *NotesMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
...
// WhereP appends storage-level predicates to the NotesMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *NotesMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.Notes, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
func (m *NotesMutation) SetOp(op Op) {
	m.op = op
}
